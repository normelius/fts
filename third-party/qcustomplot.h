...
public:
  ...
  // OWN IMPLEMENTATION. 
  // Lower and upper scale factor sets how much margin we have on the inside.
  void rescaleValueAxis(bool onlyEnlarge=false, bool inKeyRange=false, const double lowerScaleFactor = 1.0, 
    const double upperScaleFactor = 1.0) const;
